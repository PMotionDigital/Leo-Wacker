...
/* harmony import */ var _parts_formular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./parts/formular */ "./src/js/parts/formular.js");
/* harmony import */ var _parts_animation_image_hover__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./parts/animation/image-hover */ "./src/js/parts/animation/image-hover.js");
/* harmony import */ var _parts_animation_title_fadinout__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./parts/animation/title-fadinout */ "./src/js/parts/animation/title-fadinout.js");
/* harmony import */ var _parts_animation_parallax__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./parts/animation/parallax */ "./src/js/parts/animation/parallax.js");
// files
...
/***/ "./src/js/parts/animation/image-hover.js":
/*!***********************************************!*\
  !*** ./src/js/parts/animation/image-hover.js ***!
  \***********************************************/
/*! no exports provided */
...
/* harmony import */ var _interpolation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./interpolation */ "./src/js/parts/animation/interpolation.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('mousemove', '[data-image-animate]', (e) => {
    ...
    const pos = {
        x: Number(Object(_interpolation__WEBPACK_IMPORTED_MODULE_1__["default"])(e.clientX, left, left + width, -50, 50).toFixed(2)),
        y: Number(Object(_interpolation__WEBPACK_IMPORTED_MODULE_1__["default"])(e.clientY, top, top + height, -50, 50).toFixed(2))
    };
    currentImage = image;
    currentPosition = pos;
});
...
/***/ "./src/js/parts/animation/interpolation.js":
/*!*************************************************!*\
  !*** ./src/js/parts/animation/interpolation.js ***!
  \*************************************************/
/*! exports provided: default */
...
/***/ "./src/js/parts/animation/parallax.js":
/*!********************************************!*\
  !*** ./src/js/parts/animation/parallax.js ***!
  \********************************************/
/*! no exports provided */
...
const parallax = () => {
    const elems = jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-parallax]');
    if(elems.length){
        elems.each((i, el) => {
            const {top, height} = el.getBoundingClientRect();
            const bottom = top + height;
            const winHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).height();
            const elem = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el);

            const coef = elem.data('parallax') || 15;
            if(top >= -winHeight && bottom <= winHeight * 2) {
                const translate = Object(_interpolation__WEBPACK_IMPORTED_MODULE_1__["default"])(top+height/2, 0, winHeight, -1, 1) * coef * winHeight / 100;
                elem.css({
...
const coverParallax = () => {
    const elems = jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-parallax-cover]');
    if(elems.length){
        elems.each((i, el) => {
            const {top, height} = el.getBoundingClientRect();
            const bottom = top + height;
            ...
            if(top >= - height && bottom <= winHeight + height) {
                const translate = Object(_interpolation__WEBPACK_IMPORTED_MODULE_1__["default"])(top, 0, winHeight, 0, -1) * coef * winHeight / 100;
                elem.css({
                    transform: `translate3d(0, ${translate}px, 0)`,
                    height: '110%'
                });
...
/***/ "./src/js/parts/animation/title-fadinout.js":
/*!**************************************************!*\
  !*** ./src/js/parts/animation/title-fadinout.js ***!
  \**************************************************/
/*! no exports provided */
...
const titles = jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-title-animate]');
...
const titleAnimate = () => {
    titles.each((i, title) => {
        ...
        const bottom = top + height;
        const winHeight = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).height();
        const titleEl = jquery__WEBPACK_IMPORTED_MODULE_0___default()(title);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-modal="formular"] [data-close]').on('click', (e) => {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-modal="formular"]').removeClass('opened');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('html, body').css('overflow', 'auto');
    setTimeout(() => {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-modal="formular"] .loader').removeClass('hide');
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-modal="formular"] .formular-block').remove();
    }, 300);
});
function openFormular(type) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
        ...
        data: {
            action: 'formular',
            type: type,
            lang: jquery__WEBPACK_IMPORTED_MODULE_0___default()('#current_locale_').val()
        },
        beforeSend: () => {
            setTimeout(() => {
...
function successHandler(data) {
    console.log(data);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-modal="formular"]').append(data.header + data.content + data.footer);
}
...
/***/ "./src/js/parts/blocks/our-team.js":
/*!*****************************************!*\
  !*** ./src/js/parts/blocks/our-team.js ***!
  \*****************************************/
/*! no exports provided */
...
let startAt = 0;
if( jquery__WEBPACK_IMPORTED_MODULE_0___default()('.glide-slider [data-title]').length >= 3 ){
    startAt = 1;
}
const options = {
    type: 'slider',
...
if(jquery__WEBPACK_IMPORTED_MODULE_0___default()('.glide-slider').length){
    const glide = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_1__["default"]('.glide-slider', options).mount();
}


/***/ }),

/***/ "./src/js/parts/formular.js":
/*!**********************************!*\
  !*** ./src/js/parts/formular.js ***!
  \**********************************/
/*! no exports provided */
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _message__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./message */ "./src/js/parts/message.js");
...
let locale = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#current_locale_').val();

let formularData = {};
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.formular-form_item', (e) => {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.currentTarget)
        .addClass('active')
        .siblings().removeClass('active');
});

jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.formular-block_controlls button', (e) => {
    e.preventDefault();
    const direction = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.currentTarget).data('btn');
    ...
    if(direction == 'next' && submitForm) {
        ...
        if(prevStep !== currentStep) {
            flag = false;
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.formular-step.active`).stop().animate({
                opacity: 0
            }, 250, () => {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.formular-step[data-step="${prevStep}"]`).attr('style', '');
                jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.formular-step[data-step="${currentStep}"]`).css({
                    opacity: 0
                });
                jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.formular-step[data-step="${currentStep}"]`).addClass('active').siblings().removeClass('active');
                jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.formular-step[data-step="${currentStep}"]`).stop().animate({
                    opacity: 1
                }, 250, () => {
                    flag = true;
                });
...
function nextStep(dir) {
    setData(currentStep);
    const length = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.formular-step').length;
    if(valid){
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.formular-block_progress-target').css({
            transform: `translateX(${translate}%)`
        });
    }
}
function setData(step) {
    const stepWrap = jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.formular-step[data-step="${currentStep}"]`);
    ...
    if(stepWrap.find('.formular-form_item').length) {
        ...
        if(!stepValue || stepValue == '') {
            valid = false;
            _message__WEBPACK_IMPORTED_MODULE_1__["default"].setMessage(messages[locale]);
        } else {
            valid = true;
        ...
        inputs.each((i, e) => {
            const label = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).find('.label').text().trim();
            let val = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).find('input').val();
            if(jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).find('[type="radio"]').length){
                val = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).find('input:checked').siblings('p').text().trim();
            }
            if(!val || val == '') {
                valid = false;
                _message__WEBPACK_IMPORTED_MODULE_1__["default"].setMessage(messages[locale]);
        ...
        let addressString = '';
        inputs.each((i, e) => {
            if(jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).val()) {
                addressString += `${jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).attr('placeholder')}: ${jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).val()}, `;
            }
        });
        ...
        let rowString = '';
        rows.each((i, e) => {
            const rowTitle = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).find('.formular-form_radio-title:not(.head)').text().trim();
            const rowValue = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).find('[type="radio"]:checked').val();
            if(rowValue){
    ...
    if(step == jquery__WEBPACK_IMPORTED_MODULE_0___default()('.formular-step').length - 2) {
        submitForm = true;
    } else {
        submitForm = false;
    }
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('[name="your-data"]').val(dataString);
}
jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-modal="formular"] [data-close]').on('click', (e) => {
    currentStep = 0;
    formularData = {};
...
function submitFormAction() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.formular-step.active form').find('input[type="submit"]').trigger( 'click' );
}


document.addEventListener('wpcf7mailsent', function(event) {
    setTimeout(() => {
        let formText = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.wpcf7-response-output').text();
        _message__WEBPACK_IMPORTED_MODULE_1__["default"].setMessage(formText);
    }, 500);
}, false);
...
/* harmony import */ var smooth_scrollbar_dist_plugins_overscroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! smooth-scrollbar/dist/plugins/overscroll */ "./node_modules/smooth-scrollbar/dist/plugins/overscroll.js");
/* harmony import */ var smooth_scrollbar_dist_plugins_overscroll__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(smooth_scrollbar_dist_plugins_overscroll__WEBPACK_IMPORTED_MODULE_2__);
...
smooth_scrollbar__WEBPACK_IMPORTED_MODULE_1__["default"].use(smooth_scrollbar_dist_plugins_overscroll__WEBPACK_IMPORTED_MODULE_2___default.a);
if(!jquery__WEBPACK_IMPORTED_MODULE_0___default()('immobilien-app').length && jquery__WEBPACK_IMPORTED_MODULE_0___default()('#my-scrollbar').length){
    smooth_scrollbar__WEBPACK_IMPORTED_MODULE_1__["default"].init(document.querySelector('#my-scrollbar'), options);
}
...
function changeHeader() {
    const elems = jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-change-header]');
    if(elems.length) {
        elems.each((i, e) => {
            ...
            if(top <= 5 && bottom >= 0) {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('.site-header').addClass('transparent');
                console.log(top, bottom);
            } else {
                jquery__WEBPACK_IMPORTED_MODULE_0___default()('.site-header').removeClass('transparent');
            }
        });
    } else {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.site-header').removeClass('transparent');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-menu]').on('touchstart', (e) => {
    e.preventDefault();
    console.log('touch');
    const cont = jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-menu-container]');
    const contWrap = cont.find('.mobile-menu-content');
    if(menuOpened) {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.currentTarget).removeClass('opened');
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.currentTarget).addClass('opened');
        contWrap.css('opacity', '0');
...
/* harmony default export */ __webpack_exports__["default"] = ({
    setMessage: (text) => {
        if(!jquery__WEBPACK_IMPORTED_MODULE_0___default()('#massage-block').length) {
        ...
        setTimeout(() => {
            const mes = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#message-block');
            mes.addClass('opened');
